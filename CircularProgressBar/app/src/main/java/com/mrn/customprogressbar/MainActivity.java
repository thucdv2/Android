...
//            });
            ...
            CountDownTimer countDownTimer = new CountDownTimer(4000, 200) {
                @Override
                public void onTick(long millisUntilFinished) {
                    Log.d("thucdv", "tick = " + 100 * millisUntilFinished / 4000);
                    circleProgressBar.setProgressWithAnimation(100 - 100 * millisUntilFinished / 4000);
                }
